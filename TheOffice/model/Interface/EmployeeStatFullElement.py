...
class EmployeeStatFullElement(InterfaceElement):
    def __init__(self, rect, image, company):
        ...
        self._title_font = font.SysFont("Calibri", 36, True)
        self._body_font = font.SysFont("Calibri", 25, True)

        self.title_text = self._body_font.render("Statistics", True, (255, 255, 255))
        ...
        self.stat_rect = rect.copy().move(100, 50)
        self.visual_rect = rect.copy().move(400, 50)
    ...
    def update_emp_full_stats(self, emp: Employee):
        ...
        self.hire_date = self._body_font.render("Hire Date:    " + str(emp.stats.hire_date), True, (255, 255, 255))
        ...
        self.emp_name_text = self._title_font.render(str(emp.name), True, (255, 255, 255))
